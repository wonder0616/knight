...
public class MinioUtil {
    ...
    public static void main(String[] args) {
        initMinio("http://127.0.0.1:9000", "minioadmin","minioadmin");
        RemoveObjectArgs objectArgs = RemoveObjectArgs.builder().object("deviceAssets/20220824/11_1661304900781.jpg")
                .bucket("test").build();
        try {
            minioClient.removeObject(objectArgs);
