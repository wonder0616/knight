...
public class RedisUtil {
     ...
     * @param time  过期时间
     */
    public void setIfAbsent(String key, Object value, long time, @Nullable TimeUnit timeUnit) {
        redisTemplate.opsForValue().setIfAbsent(key, value, time, timeUnit.equals(null) ? TimeUnit.SECONDS : timeUnit);
